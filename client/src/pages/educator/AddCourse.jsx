...
import uniqid from 'uniqid' //to generate a unique id for each course
import Quill from 'quill' //to generate a rich text for description of each course
    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='mb-6'>
          ...
          {
            showPopup && (
              <div className='fixed inset-0 flex items-start justify-center bg-gray-800 bg-opacity-50 pt-10'>
                <div className='bg-white text-gray-700 p-2 rounded relative w-full max-w-md max-h-screen overflow-y-auto'>
                  ...
                  <div className='mb-2'>
                    <p>Lecture URL</p>
                    <input type="text" className='mt-1 block w-full border rounded py-1 px-2' value={lectureDetails.lectureDuration} onChange={(e) => setLectureDetails({...lectureDetails, lectureUrl : e.target.value})}/>
                  </div>
